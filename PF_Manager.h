...
#define PF_PAGE_SIZE ((1<<12)-4)//页面的大小
...
typedef struct{   //每一个分页的信息
	PageNum pageNum;//分页文件中页面的编号
	char pData[PF_PAGE_SIZE];//分页文件数据区的大小以及指针
}Page;

typedef struct{//除开0号页面其他页面的控制信息
